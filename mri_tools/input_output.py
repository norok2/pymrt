...
# -*- coding: utf-8 -*-
"""
mri_tools: useful I/O utilities.
...
def find_objects(
        ...
        max_label=0):
    """
    Extract labels using: mri_tools.geometry.find_objects
...
def plot_sample2d(
    ...
    Uses the function: mri_tools.plot.sample2d
...
def plot_histogram1d(
    ...
    Uses the function: mri_tools.plot.histogram1d
...
def plot_histogram2d(
    ...
    Uses the function: mri_tools.plot.histogram2d
